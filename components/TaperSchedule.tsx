    ...
    <div className="space-y-8">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between border-b-slate-100">
            <h3 className="text-lg font-bold text-slate-900 uppercase tracking-wide">Your Journey</h3>
                            ...
                            <div className={`px-5 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 ${step.isCompleted ? 'bg-slate-50/50' : 'bg-white'}`}>
                                <div>
                                    <div className="flex items-center gap-2 mb-1">
                                        <h4 className={`font-bold text-base uppercase tracking-wide ${isActive ? 'text-teal-700' : 'text-slate-900'}`}>
                                        ...
                                        >
                                            ...
                                            <div className="flex-1">
                                                <div className="flex justify-between items-center">
                                                    <span className={`text-sm font-bold ${isDone ? 'text-teal-900 line-through opacity-60' : 'text-slate-700'}`}>
                                                        Day {dayIndex + 1}
                                                    </span>
                                                    {isToday && (
                                        ...
                                        <div className="animate-in fade-in slide-in-from-top-1">
                                            {stability === 'unstable' ? (
                                                <div className="bg-white border border-red-200 rounded-none p-4 flex gap-4 items-start shadow-sm">
                                                    ...
                                                    <div>
                                                        <h5 className="font-bold text-slate-900 text-sm uppercase">Recommendation: Hold</h5>
                                                ...
                                                <div className="bg-white border border-teal-200 rounded-none p-4 flex gap-4 items-start shadow-sm">
                                                    ...
                                                    <div>
                                                        <h5 className="font-bold text-slate-900 text-sm uppercase">Ready to proceed?</h5>
                                                        <p className="text-slate-600 text-sm mt-1 leading-relaxed">
